 ...
 */
public class SelectHotImageLoadListener implements OnlineImageLoadListener, AdElementDisplay.BitmapLoadListener {

    private Context mContext;
    private int mWidth;
    private ImageView mImage;

    public SelectHotImageLoadListener(Context context, ImageView imageView, int width) {
        mContext = context;
        mWidth = width;
        mImage = imageView;
    }
