...
/**
 * Created by Xu wenxiang on 2015-7-03.
 */
public class SwipeRefreshLoadLayout extends ViewGroup {
    ...
    private DrawableCircleImageView mCircleView;
    ...
    private void createProgressView() {
        mCircleView = new DrawableCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
