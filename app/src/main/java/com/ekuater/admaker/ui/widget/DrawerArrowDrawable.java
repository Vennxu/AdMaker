...
public abstract class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        this.mSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_drawableSize);
        this.mBarSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_barSize);
        this.mTopBottomArrowSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_topBottomBarArrowSize);
        this.mBarThickness = context.getResources().getDimensionPixelSize(R.dimen.drawer_thickness);
        this.mBarGap = context.getResources().getDimensionPixelSize(R.dimen.drawer_gapBetweenBars);
        this.mMiddleArrowSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_middleBarArrowSize);
