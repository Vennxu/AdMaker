...
public class CircleImageView extends ImageView {
    ...
    private static final int DEFAULT_SHADOW_COLOR = 1;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShadowColor = a.getColor(R.styleable.CircleImageView_shadow_color, mShadowColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int centerX = paddingLeft + hspace / 2;
        final int centerY = paddingTop + vspace / 2;
        ...
        if (isPressed()) {
            canvas.drawCircle(centerX, centerY, mDrawableRadius, mShadowPaint);
        }
        if (mBorderWidth > 0) {
