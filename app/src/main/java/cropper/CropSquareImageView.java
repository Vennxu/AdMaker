...
import cropper.cropwindow.CropSquareOverlayView;
 ...
 */
public class CropSquareImageView extends FrameLayout {
    ...
    private CropSquareOverlayView mCropOverlayView;
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.crop_spquare_image_view, this, true);

        mImageView = (ImageView) v.findViewById(R.id.ImageView_image);

        setImageResource(mImageResource);
        mCropOverlayView = (CropSquareOverlayView) v.findViewById(R.id.CropOverlayView);
