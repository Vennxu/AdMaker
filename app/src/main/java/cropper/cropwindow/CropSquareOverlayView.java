...
import com.ekuater.admaker.ui.widget.PaintUtil;
 ...
 * the crop window.
 */
public class CropSquareOverlayView extends View {
    ...
    public CropSquareOverlayView(Context context) {
        super(context);
        init(context);
    }

    public CropSquareOverlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
